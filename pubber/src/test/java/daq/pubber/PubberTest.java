...
public class PubberTest extends TestBase {
  ...
  public void parseDataUrl() {
    ...
    String blobData = PubberHost.acquireBlobData(testBlobDataUrl, sha256(TEST_BLOB_DATA));
  ...
  public void badDataUrl() {
    ...
    PubberHost.acquireBlobData(testBlobDataUrl, sha256(TEST_BLOB_DATA));
  }
  ...
  public void augmentDeviceMessageTest() {
    ...
    PubberHost.augmentDeviceMessage(testMessage, new Date(), false);
